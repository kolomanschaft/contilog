...
namespace Contilog.Repositories
{
    public class DecisionRepository : IDecisionRepository
    {
        ...
        public DecisionRepository()
        {
            ...
            {
                new Decision { Id = 1, PostId = 1, Text = "We should proceed with implementing generics in our next code review session.", Author = "John Smith", CreatedDate = DateTime.Now.AddDays(-4) },
                new Decision { Id = 2, PostId = 2, Text = "Team agreed to adopt LINQ patterns in our upcoming projects.", Author = "Jane Doe", CreatedDate = DateTime.Now.AddDays(-2) },
                new Decision { Id = 3, PostId = 4, Text = "We will use Blazor Server for the company dashboard project.", Author = "Sarah Wilson", CreatedDate = DateTime.Now.AddDays(-3) },
                new Decision { Id = 4, PostId = 6, Text = "Database normalization will be implemented following the third normal form.", Author = "Lisa Chen", CreatedDate = DateTime.Now.AddDays(-5) },
                new Decision { Id = 5, PostId = 9, Text = "All React components should use hooks instead of class components going forward.", Author = "Chris Anderson", CreatedDate = DateTime.Now.AddDays(-4) }
            };
        }
